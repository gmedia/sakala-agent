...
| `SAKALA_IMAGE_GC_MAX_AGE_SECONDS` | `604800` | Umur minimum image build Sakala yang dangling sebelum GC startup. Agent memakai filter label Sakala dan tidak pernah menjalankan `docker image prune -a`. |
